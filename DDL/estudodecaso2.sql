...
Create table if not exists VOOS (
    ...
    PRIMARY KEY (VOO_ID, VOO_AEROP_ORIGEM, VOO_AEROP_DEST, VOO_AERONAVE),
...
CREATE TABLE IF NOT EXISTS EQUIPES (
    ...
    CONSTRAINT FK_EQUIPE_FUNC FOREIGN KEY (FUNC_ID) REFERENCES FUNCIONÁRIOS(FUNC_ID)
);
...
Create table if not exists RESERVAS (
    ...
    PASS_CPF INT,
    VOO_ID INT,
    PRIMARY KEY(PASS_CPF, VOO_ID, RESERVA_COD),
