...
#7: EXEMPLO DE ALTER TABLE
ALTER TABLE FORNECEDORES ADD FORNEC_EMAIL VARCHAR(100);
ALTER TABLE FILIAIS MODIFY FILIAIS_NOME VARCHAR(50) NOT NULL;
ALTER TABLE PRODUTOS ADD PRODUTOS_ESPECTEC TEXT NOT NULL;
ALTER TABLE PEDIDOS ADD PEDIDOS_PREVISÃO DATE NOT NULL;
...
ALTER TABLE FILIAIS_PRODUTOS MODIFY FLPR_QUANT DECIMAL(10,3) NOT NULL;
